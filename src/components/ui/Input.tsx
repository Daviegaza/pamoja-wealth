...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ className, label, error, hint, leftIcon, rightIcon, id, variant = "default", ...props }, ref) => {
    ...
    const baseClasses =
      variant === "filled"
        ? "h-11 w-full rounded-xl border border-transparent bg-gray-100 dark:bg-white/[0.05] px-3.5 text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 transition-all duration-200 focus:border-brand-400 dark:focus:border-brand-500 focus:bg-white dark:focus:bg-white/[0.07] focus:ring-2 focus:ring-brand-500/20 dark:focus:ring-brand-400/20 focus:outline-none"
        : "h-11 w-full rounded-xl border border-gray-300 dark:border-white/[0.07] bg-white dark:bg-white/[0.03] px-3.5 text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 transition-all duration-200 focus:border-brand-400 dark:focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 dark:focus:ring-brand-400/20 focus:outline-none";
